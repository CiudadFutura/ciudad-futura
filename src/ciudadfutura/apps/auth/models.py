...
class User(AbstractBaseUser):
    ...
    reset_password_sent_at = models.CharField()
    confirmed_at = models.CharField()
    confirmation_token = models.CharField()
    confirmation_sent_at = models.CharField()
    unconfirmed_email = models.CharField()
    sign_in_count = models.CharField()
    current_sign_in_at = models.CharField()
    last_sign_in_at = models.CharField()
