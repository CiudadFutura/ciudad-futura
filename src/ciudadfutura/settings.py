"""
Django settings for ciudadfutura project.
...
SECRET_KEY = 'zsf=tfgib&kn=4xjbv(#ej)56=fmj4+w83q9=_v$-9btks2auk'
...
WSGI_APPLICATION = 'ciudadfutura.wsgi.application'
